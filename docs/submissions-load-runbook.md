...
*Updated 2026-09-06 15:26 EDT — pinned to `2ed70b6`, version `2026.09.06-15`*
...
```powershell
.\vault.ps1 update -Commit 2ed70b69ed553e4d7e75470921711faf0ffa4746
```
...
```powershell
curl.exe -sfLO https://raw.githubusercontent.com/kevinnassery/veeva/2ed70b69ed553e4d7e75470921711faf0ffa4746/vault.ps1
```

```powershell
powershell -ExecutionPolicy Bypass -File .\vault.ps1 update -Commit 2ed70b69ed553e4d7e75470921711faf0ffa4746
```
