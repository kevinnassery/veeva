<!-- source: https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-record-attachments/retrieve-object-record-attachments/ -->
<!-- title: Retrieve Object Record Attachments -->
...
On `SUCCESS`, the response lists the following metadata for each attachment on the requested object record:
