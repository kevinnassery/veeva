<!-- source: https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/retrieve-all-document-roles/ -->
<!-- title: Retrieve All Document Roles -->
