<!-- source: https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/replace-document-version-rendition/ -->
<!-- title: Replace Document Version Rendition -->
