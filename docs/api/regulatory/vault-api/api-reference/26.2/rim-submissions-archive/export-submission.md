<!-- source: https://general.veevavault.dev/regulatory/vault-api/api-reference/26.2/rim-submissions-archive/export-submission/ -->
<!-- title: Export Submission (Legacy) -->

# Export Submission (Legacy)
...
Use the following requests to export the latest version of a Submissions Archive binder, including submissions published by RIM Submissions Publishing. Learn more about [RIM Submissions Publishing in Vault Help](https://regulatory.veevavault.help/en/gr/48611).
...
https://myvault.veevavault.com/api/v26.2/objects/binders/454/actions/export?submission=00S000000000101
```
